from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, QGridLayout,
                           ...
                           QFrame, QMainWindow, QFileDialog, QGroupBox, QRadioButton)
from PyQt5.QtGui import QPixmap, QPainter, QPen, QColor, QImage
from PyQt5.QtCore import Qt, QRect, QSize, pyqtSignal, QRectF, QPoint
from PIL import Image, ImageQt
import os

class EnhancedImageGridView(QWidget):
    """Enhanced widget to display a grid of images with metadata, bounding boxes, and borders"""
    ...
    def setup_grid(self) -> None:
        ...
        # Create new grid of EnhancedImageWidget instances
        for row in range(self.rows):
            for col in range(self.cols):
                image_widget = EnhancedImageWidget()
    ...
    def set_images_from_collection(self, collection) -> None:
...
class EnhancedImageWidget(QWidget):
    """Enhanced widget to display a single image with metadata, bounding boxes, and borders"""
